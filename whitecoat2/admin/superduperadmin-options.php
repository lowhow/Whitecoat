...
$args['opt_name'] = 'superduper';

//Custom menu icon
//$args['menu_icon'] = '';

//Custom menu title for options page - default is "Options"
$args['menu_title'] = __('Admin Options', 'nhp-opts');
...
$sections[] = array(
  /**
   * @todo Come back to empty values later.
   */
  'title'   => 'Wordpress Settings',
  'desc'    => 'Wordpress Preliminary Setups',
  'fields'  =>  array(
    array(
      'id'        => 'sd_favicon_link',
      'type'      => 'text',
      'title'     => 'Favicon Link Url',
      'sub_desc'  => '<pre>pb_favicon_link</pre>',
      'desc'      => 'Leave blank to use default <div>Default is <code>'.get_bloginfo('stylesheet_directory') . '/images/favicon.ico</code></div>',
      'validate'  => 'url',
      'msg'       => 'Invalid url format',
    ),
    array(
      'id'        => 'sd_remove_wp_generator',
      'type'      => 'checkbox',
      'title'     => 'Remove Wordpress Generator',
      'sub_desc'  => '<pre>sd_remove_wp_generator</pre>',
      'desc'      => '',
      'std'       => '1'
    )
  )
...
//  'desc'    => 'Responsives layout, fluid/fixed,',
//  'fields'  =>  array(
//    array(
//      'id'        => 'sd_favicon_link',
//      'type'      => 'text',
