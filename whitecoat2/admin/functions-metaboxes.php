...
if (is_admin() && $piggyback->wpalchemy) {
   ...
   */
  wp_enqueue_style('jquery-ui-style-aristo', PIGGYBACK_MEDIA_URL.'/taitems-Aristo-jQuery-UI-Theme/css/Aristo/Aristo.css');
   ...
   */  
  $jqueryvalidation_js = $piggyback->jqueryvalidation->get_js();
